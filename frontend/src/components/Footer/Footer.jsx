...
return(
<>
<footer className="bg-white pt-16 pb-8 px-6 md:px-20 lg:px-32 border-t
  border-slate-100">
...
Potencia la Colaboración de tu equipo con IA. Organiza, asigna y completa proyectos de manera más eficiente que nunca.
  ...
  <div className="flex gap-4 text-slate-400">
    ...
    <a href="#" className="hover:text-sky-500 transition-colors">Email</a>
    </div>
  </div>
...
<a href="#" className="hover:text-slate-600">Términos de Servicios</a>
<a href="#" className="hover:text-slate-600">Política de Privacidad</a>
<a href="#" className="hover:text-slate-600">Cookies</a>
</div>
<p className="text-xs text-slate-400">
Hecho con React, Tailwind © 2025 Worklyst. Todos los derechos Reservados
</p>
</div>
</footer>
</>
